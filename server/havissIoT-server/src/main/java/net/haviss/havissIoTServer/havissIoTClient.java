 ...
 * This class connects to an MQTT broker (using Paho MQTT libraries) and handles communication between the broker and client.
 * Its mostly a wrapper for the PAHO MQTT library.
 *
 */
